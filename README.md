...
- [**BrandBuildr**](design-md/brandbuildr/) — Strategic brand-building SaaS. Restrained light surfaces, phase colours, dark slate session canvas *(this fork only; lives under `design-md/brandbuildr/` here)*
